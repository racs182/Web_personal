	...
	<div class="row">
		<div class="grid6">
			...
			<div class="row">
				<div class="thumbnails_perfil grid2">
					<img src="http://placehold.it/80x80" alt=""></div>
				<div class="txt_perfil grid4">
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicingad ipisicing elit. Suscipit, repellat porro repudiandae laboriosam  Consectetur! repudiandae laboriosam
					</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="txt_perfil grid4">
					<p>
						Lorem ipsum dolor sit amet, re pudiandae labor iosam consectetur adipisicing elit. Suscipit, repellat repellat porro repudiandae laboriosam  Consectetur!
					</p>
				</div>
			</div>
		</div>
		<div class="grid6">
			...
			<div class="row">
				...
				<div class="grid6">
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde, rem, ullam deleniti officia ad impedit dolores explicabo perspiciatis est obcaecati consequuntur suscipit minima vitae porro quia vero ab aliquam dolore.
					</p>
				</div>
			</div>
		</div>
