...
<div id="#huella" class="box-huella grid12">
	...
	<div class="row">
		<div class="grid4">
			...
			<img src="http://placehold.it/300x250" alt=""></div>
		<div class="grid4">
		...
		<div class="grid4">
			...
			<div class="box-network">
				...
				<div class="icons-box-footer">
					<a href="#"> <i class="icons-footer">g</i>
					</a>
					<a href="#"> <i class="icons-footer"></i>
					</a>
					<a href="#">
						<i class="icons-footer">h</i>
					</a>
					<a href="#">
						<i class="icons-footer"></i>
					</a>
				</div>
